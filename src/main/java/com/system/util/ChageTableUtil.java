...
//    public  List<String> getImageList
    ...
    public static String graphicsGeneration(List<List<List<String>>> allValue, List<String> titles, List<String[]> headers, String receiver, int totalcol) throws Exception {
        ...
        File upload = new File(path.getAbsolutePath(), "static/images/upload/" + StringUtil.getUUIdByMonth() + "/");
        if (!upload.exists()) {
            upload.mkdirs();
        }
        System.out.println("upload url:" + upload.getAbsolutePath());
        String imageName = "custom" + StringUtil.getImageUUIdByTime() + ".png";
        String newPath = upload.getAbsolutePath() + "/" + imageName;
